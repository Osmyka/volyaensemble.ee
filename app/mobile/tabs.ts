...
export type TabId = "home" | "schedule" | "merch" | "gallery" | "contact";
...
/**
 * Five destinations, and destinations only — the join action lives in the
 * header on every page. "Schedule" and "Merch" point at their own pages rather
